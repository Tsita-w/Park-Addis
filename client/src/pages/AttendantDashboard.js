...
const AttendantDashboard = () => {
  ...
  // Add a state to toggle views
  const [view, setView] = useState("dashboard");

  if (view === "incident")
    return <IncidentReport onBack={() => setView("dashboard")} />;

  // In your main return, add a button:
  <button
    onClick={() => setView("incident")}
    className="w-full border-2 border-red-100 text-red-500 py-3 rounded-2xl font-bold flex items-center justify-center gap-2 mt-4"
  >
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button className="p-2 bg-white rounded-full shadow-sm text-gray-400 hover:text-red-500">
          <LogOut size={20} />
        </button>
      </div>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-xl border border-gray-100 flex flex-col items-center">
          {isScanning ? (
            ...
            <div className="w-full flex flex-col items-center">
              <div className="w-full aspect-square bg-gray-900 rounded-2xl mb-6 flex items-center justify-center relative">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-4 rounded-2xl font-black text-lg hover:bg-blue-700 active:scale-95 transition-all"
              >
                START SCANNER
              </button>
            </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              disabled={loading}
              className="bg-green-500 text-white p-4 rounded-2xl font-bold flex flex-col items-center gap-1 hover:bg-green-600 disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={loading}
              className="bg-orange-500 text-white p-4 rounded-2xl font-bold flex flex-col items-center gap-1 hover:bg-orange-600 disabled:opacity-50"
            >
